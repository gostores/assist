...
var errNegativeNotAllowed = errors.New("unable to assist negative value")

// ToTimeE assists an interface to a time.Time type.
...
// ToDurationE assists an interface to a time.Duration type.
...
// ToBoolE assists an interface to a bool type.
...
// ToFloat64E assists an interface to a float64 type.
...
// ToFloat32E assists an interface to a float32 type.
...
// ToInt64E assists an interface to an int64 type.
...
// ToInt32E assists an interface to an int32 type.
...
// ToInt16E assists an interface to an int16 type.
...
// ToInt8E assists an interface to an int8 type.
...
// ToIntE assists an interface to an int type.
...
// ToUintE assists an interface to a uint type.
...
// ToUint64E assists an interface to a uint64 type.
...
// ToUint32E assists an interface to a uint32 type.
...
// ToUint16E assists an interface to a uint16 type.
...
// ToUint8E assists an interface to a uint type.
...
// ToStringE assists an interface to a string type.
...
// ToStringMapStringE assists an interface to a map[string]string type.
...
// ToStringMapStringSliceE assists an interface to a map[string][]string type.
...
// ToStringMapBoolE assists an interface to a map[string]bool type.
...
// ToStringMapE assists an interface to a map[string]interface{} type.
...
// ToSliceE assists an interface to a []interface{} type.
...
// ToStringSliceE assists an interface to a []string type.
